            ...
            <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
                <form className="card-body">
                    ...
                    <div className="form-control mt-6 flex flex-row justify-center gap-5">
                        <button data-testid="signin-button" type="button" className="btn btn-primary flex-1" onClick={handleOnClickSignIn} disabled={!isValidation}>
                            로그인
                        </button>
                        <button data-testid="signup-button" type="button" className="btn flex-1" onClick={() => navigation("/signup")}>
                            회원가입
                        </button>
                    </div>
                </form>
